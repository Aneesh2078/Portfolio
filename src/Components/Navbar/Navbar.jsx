  ...
  return (
    <nav className="flex flex-wrap justify-between md:items-center text-white px-10 pt-6 md:px-20">
      ...
      <ul
        ...
        <a href="#Achievements"><li className="text-md transition-all duration-300 p-1 md:p-0">Achievements</li></a>
        <a href="#Workshops"><li className="text-md transition-all duration-300 p-1 md:p-0">Workshops</li></a>
